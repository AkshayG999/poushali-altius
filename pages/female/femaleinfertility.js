    ...
    return (
        ...
        <div className={styles.bodymwrap}>
            ...
            <div className={styles.bodywrap}>
                ...
                <p className={styles.pwrap}>Lorem ipsum dolor sit amet consectetur adipisicing</p>
            </div>
            <h1 className={styles.headingmwrap}>
                ICSI
            </h1>
            <div className={styles.bodywrap}>
                <p className={styles.pwrap}>Lorem ipsum dolor sit amet consectetur adipisicing elit.</p>
            ...
            <div className={styles.bodywrap}>
                ...
                <p className={styles.pwrap}>Lorem ipsum dolor sit amet consectetur adipisicing elit. Maxime mollitia,
                    molestiae quas vel sint commodi repudiandae consequuntur voluptatum labor</p>
