...
<p className={styles.pwrap}>IUI, or intrauterine insemination, is a type of fertility treatment that involves the placement of sperm directly into the uterus through a catheter. It is often used to treat couples who are struggling to conceive due to issues with sperm count, motility, or cervical mucus.

The procedure is relatively simple and painless, and can be done in a clinic or doctor's office. It is typically timed with the woman's ovulation cycle to increase the chances of fertilization.

IUI is a less invasive and less expensive option compared to other fertility treatments such as IVF. However, success rates can vary depending on individual factors such as age, cause of infertility, and overall health. It is important to consult with a healthcare professional to determine if IUI is the best option for your unique situation.</p>
...
IVF is a complex and expensive procedure, but can offer hope to couples who have been unable to conceive through other methods. Success rates can vary based on age, health status, and other factors. It is important to consult with a qualified healthcare professional to determine if IVF is the best option for your individual situation</p>
<Image
