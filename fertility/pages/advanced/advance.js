...
const advance = () => {
  ...
  return (
    ...
    <div className={styles.bodywrap}>
      <img className={styles.imgwrap} src='https://i0.wp.com/fertilityworld.in/blog/wp-content/uploads/2022/03/SEMEN-FREEZING-OR-SEMEN-CRYOPRESERVATION-IN-INDIA.jpeg?w=1599&ssl=1' width="400" height="300" alt=''/>
...
totam ratione voluptas quod exercitationem fuga. Possimus quis earum veniam 
quasi aliquam eligendi, placeat qui corporis!</p>
<img className={styles.imgwrap} src='https://i0.wp.com/fertilityworld.in/blog/wp-content/uploads/2022/03/Semen-cryopreservation.jpeg?w=650&ssl=1' width="400" height="300" alt=''/>
