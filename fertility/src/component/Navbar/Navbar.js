...
function Navbar() {
    return (
        <div className='main-box'>
            ...
            <div classsName="list-nav">
                <NavDropdown title="Resources" className='drop-1' >
                    <NavDropdown.Item href="#action/3.1" className="list-content">
                    <img src="https://altiushospital.com/wp-content/uploads/2023/03/BLOG-1-300x300.png" className="list-icon" alt="..." />
                    Blogs
                    </NavDropdown.Item>
                    <NavDropdown.Item href="#action/3.2" className="list-content">
                    <img src="https://altiushospital.com/wp-content/uploads/2023/03/news-300x300.png" className="list-icon" alt="..." />
                    News-Letter
                    </NavDropdown.Item>
                    <NavDropdown.Item href="#action/3.3" className="list-content">
                    <img src="https://altiushospital.com/wp-content/uploads/2023/02/video-gallery.svg" className="list-icon" alt="..." />
                    Video Gallery
                    </NavDropdown.Item>
            ...
            <button className="nav-button active">
                <Link class="nav-link-button" href="#"> <span className="button-contact">Get in touch</span></Link>
            </button>
            <button className="nav-button active">
                <Link className="nav-link-button" href="#"><span class="button-contact2">Call 8882799799 </span></Link>
            </button>
